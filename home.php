  <ul id="mycart">
    ...
    <li>
      ...
      <button class="cartadd" data-cart='<?php echo json_encode(array('id'=>33, 'name'=>'Lapis', 'price'=>'120')) ?>'>Adicionar</button>
    </li>

    <li>
      Product Name: Borracha <br/>
      Product Price: R$ 1,50 <br/>
      <button class="cartadd" data-cart='<?php echo json_encode(array('id'=>57, 'name'=>'Borracha', 'price'=>'1.5')) ?>'>Adicionar</button>
    </li>
